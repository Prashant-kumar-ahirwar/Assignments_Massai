# Hypothesis Test Notes — Campaign Experiment
...
The Z-score of 3.25 is well beyond the critical value of 1.645. The one-tailed p-value of 0.000573 is far below the 0.05 significance threshold. This means:
...
- Chi-square test corroborates the Z-test result (p=0.001743)
