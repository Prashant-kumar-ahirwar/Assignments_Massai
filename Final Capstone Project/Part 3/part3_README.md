...
| **MLR** | All 7 numeric + 6 dummies | **0.8380** | **Best model** |

---

## Final Model Selected

**Multiple Linear Regression** — R² = 0.8380, Adjusted R² = 0.8311

Explains 83.8% of monthly sales variation. All major predictors statistically significant at p < 0.05 except avg_discount_pct, region_North, and store_Mall.
