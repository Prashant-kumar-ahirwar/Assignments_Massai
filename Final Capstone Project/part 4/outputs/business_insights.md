...
**Generated:** 2026-06-25 06:58:00
**Dataset:** 4,200 orders | Jan 2024 – Dec 2025
...
**Data Evidence:** Total sales = ₹217.0M across 4,200 orders.
Monthly sales range from ₹6.3M to ₹10.9M.
...
**Observation:** South region generates the highest sales (₹64.7M) with a
profit margin of 15.4%, outperforming all other regions.

**Data Evidence:** Regional sales — South: ₹64.7M,
North: ₹54.6M,
West: ₹48.9M,
East: ₹48.9M.
...
**Observation:** Technology category generates ₹28.0M
in profit (84.2% of total),
at a 18.2% average margin.

**Data Evidence:** Category profit — Technology: ₹28.0M,
Furniture: ₹3.6M,
Office Supplies: ₹1.7M.

**Business Interpretation:** Technology is the profit engine of this business.
Furniture's 6.9% margin warrants review — it may be pulling down overall profitability.
...
**Data Evidence:** Tables sub-category: profit margin ≈ 5.7%.
Total Tables loss = ₹732K.
...
**Observation:** Home Office segment achieves a 15.5% margin vs
Corporate (15.2%) and Consumer (15.3%).

**Data Evidence:** Segment margins — Home Office: 15.5%,
Corporate: 15.2%, Consumer: 15.3%.
...
Orders with >30% discount show an average loss of ₹1,601.

**Data Evidence:** Avg profit by discount band:
No Discount=₹13,203,
Very High (>30%)=₹-1,601.

**Business Interpretation:** Deep discounts are destroying value. The 64 orders
with >30% discount represent a direct ₹102K loss.
...
## Insight 7 — Shipping: Standard Class Averages 4.7 Days vs 0.4 for Same Day
**Observation:** 58% of orders use Standard Class shipping (avg 4.7 days).
Slow delivery (6+ days) correlates with a 4.8% return rate vs 4.3% for Express.

**Data Evidence:** Ship mode avg days — Same Day: 0.4d, First Class: 1.8d,
Second Class: 2.7d, Standard Class: 4.7d.
...
**Observation:** High-discount orders (>20%) have a 6.1% return rate
vs 4.0% for zero-discount orders.
