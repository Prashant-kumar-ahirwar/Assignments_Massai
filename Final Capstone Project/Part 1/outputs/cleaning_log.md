...
- **32 additional records** share duplicate `order_id` values but contain conflicting data

### Missing Values
- `region`: 26 null values
- `ship_mode`: 22 null values
- `discount`: 18 null values

### Discount Issues
- **16 records** with negative discount (invalid)
...
| Flag Type | Count |
|-----------|-------|
| Duplicate order_id (conflicting) | 32 |
